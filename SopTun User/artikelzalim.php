...
// ambil artikel
$result = mysqli_query($conn, "SELECT * FROM zalim");
...
<head>
  ...
  <title>Perbuatan Dzalim</title>
  <link rel="stylesheet" href="artikelzalim.css">
  ...
  <div class="container">
    ...
    <div class="container">
      ...
      <div class="main-content">
        ...
        <!-- start button -->
        <div class="button">
          <a href="artikelsopan.php"><input type="button" value="Previous" style="color: white; font-weight: bold; font-size: 20px;"></a>
          <a href="artikelkebersihan.php"><input type="button" value="Next" style="color: white; font-weight: bold; font-size: 20px;"></a>
        </div>
        <!-- end button -->
      </div>
      <!-- start footer -->
