...
// ambil artikel
$result = mysqli_query($conn,"SELECT * FROM bersih");
...
if(tambah($_POST) > 0 ) {
    ...
    document.location.href = 'artikelkebersihan.php';
    </script>
    ";
} else {
    echo "
...
<head>
    ...
    <title>Menjaga Kebersihan</title>
    <link rel="stylesheet" href="artikelkebersihan.css">
        ...
        <div class="nav">
          ...
          <div class="container">
            ...
            <div class="main-content">
                ...
                <img src="./asset/kebersihan2 1.jpg">
            ...
            <!-- start definisi -->
            <div class="definisi">
                <img src="./asset/kebersihan1 1.jpg">
                <p><?php echo $row["definisi"]; ?></p>
            </div>
            <!-- end definisi -->
            <!-- start contoh -->
            <div class="contoh">
                <img src="./asset/kebersihan3 1.jpg">
                <h2><?php echo $row["judul_macam"]; ?></h2>
               <p><?php echo $row["macam"]; ?></p>
            </div>
            <!-- end contoh -->
            <!-- start cara -->
            <div class="cara-menghindari">
...
?>
            ...
            <!-- start button -->
            <div class="button">
                <a href="artikelzalim.php"><input type="button" value="Previous" style="color: white; font-weight: bold; font-size: 20px;"></a>
                <a href="quiz1.php"><input type="button" value="Next" style="color: white; font-weight: bold; font-size: 20px;"></a>
            </div>
            <!-- end button -->
            </div>
              <!-- start footer -->
