...
$artikel = query("SELECT * FROM bersih");
?>
...
<head>
    ...
    <link rel="stylesheet" href="managekebersihan.css">
    <style>
...
<div id="navbar">
    ...
    <h1>Artikel Menjaga Kebersihan</h1>
    <a href="tambahkebersihan.php">Tambah artikel</a>
    <br><br>
